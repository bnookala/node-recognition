...
const wechat = require('botbuilder-wechat-connector');
...
var wechatConnector = new wechat.WechatConnector({
    appID: process.env.WECHAT_ID,
    appSecret: process.env.WECHAT_SECRET,
    appToken: process.env.WECHAT_TOKEN,
    storageConnectionString: process.env.MONGO_URL
});

var bot = new botbuilder.UniversalBot(wechatConnector);
